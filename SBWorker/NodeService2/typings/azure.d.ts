...
declare module "azure" {
    ...
    export interface QueueRecieveOptions {
        isPeekLock?: boolean;
        timeoutIntervalInS?: number;
    }
    export class ServiceBusService {
        
        receiveQueueMessage(queuePath: string, options: QueueRecieveOptions, callback)
    }
    ...
    interface RoleEnvironmentInterface extends events.NodeEventEmitter {
    ...
    export class ServiceClient extends events.NodeEventEmitter {
